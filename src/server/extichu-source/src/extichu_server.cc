...
class ExtichuServer : public Component
{
public:
  static bool Install(const ArgumentMap &arguments)
  {
    ...
    // You can override gflag like this: ./extichu-local --example_arg3=hahaha
...
REGISTER_STARTABLE_COMPONENT(ExtichuServer, ExtichuServer)
