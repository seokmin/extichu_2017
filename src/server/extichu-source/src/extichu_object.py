...
attribute = funapi.AttributeModel('UserID', 'String', True, False, False, False, False, '')
object.add_attribute_model(attribute)
attribute = funapi.AttributeModel('Nickname', 'String', False, False, False, False, False, '')
object.add_attribute_model(attribute)
...
class User:
  ...
  @staticmethod
  def fetch_by_UserID(value):
    model = funapi.ObjectModel.get_object_model('User')
    obj = funapi.Object.fetch_by(model, 'UserID', value)
    if obj == None:
      return None
    return User(obj)
  ...
  def get_UserID(self):
    return self.object_.get_attribute('UserID')

  def set_UserID(self, value):
    self.object_.set_attribute('UserID', value)

  def get_Nickname(self):
    return self.object_.get_attribute('Nickname')

  def set_Nickname(self, value):
    self.object_.set_attribute('Nickname', value)
